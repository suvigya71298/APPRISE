...
public class Report_model_data {
    ...
    public Report_model_data(String job_no, String buyer, String style, String production_qty, String fabric, String color, String buyer_po, String order_qty, String total_issue, String total_received, String balance,String Date) {
        this.job_no = job_no;
        this.buyer = buyer;
        this.style = style;
