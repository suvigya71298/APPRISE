...
public class FinishingJobNumber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finishing_job_number);
        listView=findViewById(R.id.finishing_listview);
        tv1=findViewById(R.id.finishing_jobnotv1);
        toolbar=findViewById(R.id.actionbar8);
        ...
        call.enqueue(new Callback<List<Job_data>>() {
            ...
            public void onResponse(Call<List<Job_data>> call, Response<List<Job_data>> response) {
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent=new Intent(FinishingJobNumber.this,Finishing_data.class);
            ...
            public void onFailure(Call<List<Job_data>> call, Throwable t) {
                Toast.makeText(FinishingJobNumber.this, "Retrofit Failed", Toast.LENGTH_SHORT).show();
            }
        });
